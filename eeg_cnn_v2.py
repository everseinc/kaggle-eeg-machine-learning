...
with tf.Graph().as_default():
    ...
    with tf.name_scope('normalizatio4'):
    ...
    with tf.Session() as sess:
        train_writer = tf.train.SummaryWriter(SUMMARY_DIR + '/train2', sess.graph)
        ...
        for n in range(1,8):
            for m in range(1,12):
                ...
                ckpt = tf.train.get_checkpoint_state('./saver_cnn_sl/train2/')
                if ckpt:
                ...
                saver.save(sess, "./saver_cnn_sl/train2/model.ckpt")
                print('== accuracy ==')
