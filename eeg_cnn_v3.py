...
with tf.Graph().as_default():
    ...
    with tf.Session() as sess:
        train_writer = tf.train.SummaryWriter(SUMMARY_DIR + '/trai3', sess.graph)
        ...
        ckpt = tf.train.get_checkpoint_state('./saver_cnn_sl/train3/')
        if ckpt:
        ...
        saver.save(sess, "./saver_cnn_sl/train3/model.ckpt")
        print('== accuracy ==')
